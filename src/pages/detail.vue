            ...
            <div class="container clearfix">
                ...
                <div class="content">
                    ...
                    <div class="item-version clearfix">
                        <h2>选择版本</h2>
                        <div class="phone fl " v-bind:class="{'checked':version==1}" @click="version=1">6GB+64GB
                            全网通</div>
                        <div class="phone fr" v-bind:class="{'checked':version==2}" @click="version=2">4GB+64GB
                            移动4G</div>
                    </div>
                    ...
                    <div class="item-total">
                        <div class="phone-info clearfix">
                            <div class="fl">{{product.name}} {{version==1?'6GB+64GB 全网通':'4GB+64GB 移动4G'}} 深空灰色 </div>
    ...
    methods: {
        ...
        addCart() {
            this.axios.post('/carts', {
                ...
                this.$store.dispatch('saveCartCount', res.cartProductVoList.cartTotalQuantity)
